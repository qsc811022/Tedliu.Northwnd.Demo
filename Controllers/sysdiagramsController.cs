...
namespace Tedliu.Northwnd.Demo.Controllers
{
    public class sysdiagramsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "diagram_id,name,principal_id,version,definition")] sysdiagram sysdiagram)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "diagram_id,name,principal_id,version,definition")] sysdiagram sysdiagram)
        {
            if (ModelState.IsValid)
            {
